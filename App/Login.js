        ...
        <SafeAreaProvider style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : ""} style={{ flex: 1 }}>
                <ImageBackground source={require('./assets/background.jpg')} style={{ flex: 1 }} >
                    <ScrollView>
                        <View style={{ flex: 1 }}>
                            <View style={{ height: AdjustFontSize(140) }}></View>
                            <View style={{ flex: 1, }}>
                                <Text style={{ fontSize: AdjustFontSize(23), fontWeight: 'bold', color: '#311221', marginLeft: AdjustFontSize(20), marginBottom: 5 }}>{'Sign In'}</Text>
                                <View style={{ width: '80%', alignSelf: 'center', marginTop: AdjustFontSize(40), }}>
                                    ...
                                    <TouchableOpacity onPress={()=>navigation.navigate('HomeDrawer')} style={{ width: '100%', height: AdjustFontSize(40), borderRadius: 40, backgroundColor: '#966AF8', marginTop: AdjustFontSize(20), justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.55, shadowRadius: 4, elevation: 5 }}>
                                        <Text style={{ fontSize: AdjustFontSize(12), color: '#fff', fontWeight: '500', alignSelf: 'center' }}>{'Sign In'}</Text>
                                    </TouchableOpacity>
                                    <View style={{ width: '100%', marginTop: AdjustFontSize(15), justifyContent: 'center' }}>
                                        <Text style={{ fontSize: AdjustFontSize(11), color: '#966AF8', marginLeft: AdjustFontSize(10) }}>{'Forgot Password?'}</Text>
                                    </View>
                                ...
                                <View style={{ alignSelf: 'center', marginTop: AdjustFontSize(50), marginBottom: AdjustFontSize(10) }}>
                                    <Text style={{ fontSize: AdjustFontSize(12), alignSelf: 'center', color: '#311221', fontWeight: '500', }}>{`Don't have an account?`}<Text onPress={() => navigation.navigate('Signup')} style={{ color: '#966AF8' }}>{' Sign Up'}</Text></Text>
                                </View>
                            </View>
                        </View>
                    </ScrollView>
...
{/* <View style={{ width: '80%', alignSelf: 'center' }}>
                            <TextInput style={{ fontSize: AdjustFontSize(12), backgroundColor: '#fff', height: AdjustFontSize(35),paddingLeft:10,}}
                                theme={{ roundness: 80 ,}}
